  ...
  return (
    ...
    >
      ...
      <div className="flex justify-between items-start mb-4">
        <div className="flex-1">
          ...
          <div className="mt-2 text-[11pt] leading-tight">
            ...
            <p className="whitespace-pre-wrap">{personalInfo.presentAddress}</p>
          ...
          {education.map((edu) => (
            <div key={edu.id} className="mb-3">
              ...
              <div className="ml-6">
                ...
                <InfoRow label="Result" value={edu.gpa} />
            ...
            <div key={skill.id} className="mb-2">
              <BulletItem primaryColor={theme.primaryColor}>
                <div className="flex flex-col">
                  {skill.hasTraining && (
                    <span>Completed a {skill.duration} computer training program from {skill.instituteName} Institute.</span>
                  )}
        ...
        <section className="break-before-auto">
          ...
          <div className="flex justify-between items-start">
            <div className="flex-1">
              ...
              <InfoRow label="Permanent Address" value={personalInfo.permanentAddress} />
      ...
      <div className="mt-auto pt-4 flex justify-center">
        <p className="text-[3pt] text-gray-300 italic">

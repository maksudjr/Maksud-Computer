...
export const translations = {
  en: {
    dashboard: {
      ...
      status: "Status",
      online: "Online",
      coinUsage: "Coin Usages",
      freeTrial: "Free Access Usage",
      trial: "Trial",
  ...
  bn: {
    dashboard: {
      ...
      status: "অবস্থা",
      online: "অনলাইন",
      coinUsage: "কয়েন ব্যবহার",
      freeTrial: "ফ্রি ট্রায়াল ব্যবহার",
      trial: "ট্রায়াল",
      ...
      newUserInfo: "১টি সিভি এবং অন্য সকল টুলসের ২বার ব্যবহার অন্তর্ভুক্ত।",
      getFreeAccess: "ফ্রি এক্সেস নিন",
      freeAccessSuccess: "অভিনন্দন! আপনি ফ্রি এক্সেস পেয়েছেন।",
      home: "হোম",
      pricing: "মূল্যতালিকা",
      contactUs: "যোগাযোগ",
      tools: {
        ...
        pdfToImg: "পিডিএফ টু ইমেজ",
        pdfToWord: "পিডিএফ টু ওয়ার্ড",
        pdfCompress: "পিডিএফ কমপ্রেস",
      ...
      toolDescriptions: {
        ...
        pdfMerge: "একাধিক পিডিএফ ফাইলকে একটিতে সংযুক্ত করুন।",
